...
#define LEN_DELE      26//23//len_deleminator = ID=<2*4-Bytes>&DT=<2*4-Bytes>&G=<data-(dlen*2)> //1-CHAR 1-BYTES 4-BIT DATA//ID=00190014&DT=00000000&G=0EFF01030400000000/0F0102030400000000
#define REPLY_TOUT    5000//10000//SERVER REPLY TOUT
...
beg:
  ...
  if (!GSM.CheckCmd(F("AT+HTTPDATA=100,10000"), F("DOW"), ZF3E0, tout1)) {//DOWNLOAD
    goto retry;
  }
